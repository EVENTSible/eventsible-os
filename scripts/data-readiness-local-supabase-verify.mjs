...
if (execute("select count(*) from pg_indexes where schemaname='public' and tablename='os_import_batch_items' and indexname in ('os_import_batch_items_batch_status_idx','os_import_batch_items_source_hash_idx')") !== "2") throw new Error("Data Readiness staging indexes are incomplete.");
