...
if(JSON.stringify(canonical)!==JSON.stringify({contacts:24,events:24,bookings:22,services:22,payments:22,assignments:3,notes:24,provenance:24}))throw new Error(`Complete canonical counts differ: ${JSON.stringify(canonical)}`);
