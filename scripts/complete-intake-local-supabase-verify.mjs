...
if(execute(`select count(*) from public.os_event_notes where body='Historical organizer: Synthetic Organizer (provenance only; no team account).'`)!=="1"||execute("select count(*) from public.os_team_members")!=="3")throw new Error("Historical organizer provenance created or altered an operational team account.");
