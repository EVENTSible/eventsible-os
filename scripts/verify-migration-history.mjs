...
if (manifest.migrations.length !== 52) {
  throw new Error(`Expected 52 canonical migrations, found ${manifest.migrations.length}.`);
}
...
console.log(
  `Migration history verified: 52 immutable canonical migrations${
