...
if (manifest.migrations.length !== 46) {
  throw new Error(`Expected 46 canonical migrations, found ${manifest.migrations.length}.`);
}
...
console.log(
  `Migration history verified: 46 immutable canonical migrations${
