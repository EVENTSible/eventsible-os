...
if (manifest.migrations.length !== 48) {
  throw new Error(`Expected 48 canonical migrations, found ${manifest.migrations.length}.`);
}
...
console.log(
  `Migration history verified: 48 immutable canonical migrations${
