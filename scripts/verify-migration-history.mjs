...
if (manifest.migrations.length !== 49) {
  throw new Error(`Expected 49 canonical migrations, found ${manifest.migrations.length}.`);
}
...
console.log(
  `Migration history verified: 49 immutable canonical migrations${
