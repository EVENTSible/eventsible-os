...
if (manifest.migrations.length !== 47) {
  throw new Error(`Expected 47 canonical migrations, found ${manifest.migrations.length}.`);
}
...
console.log(
  `Migration history verified: 47 immutable canonical migrations${
