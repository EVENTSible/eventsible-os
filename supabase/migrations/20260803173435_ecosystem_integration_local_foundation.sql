-- EVENTSible Ecosystem Integration Foundation production-safe migration candidate.
-- Additive outbox foundation only. This file must not replace live intake functions
-- or create synthetic CI-local CRM/quote schema objects.
