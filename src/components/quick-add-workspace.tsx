...
function ContactForm({ action }: { action: Action }) {
  ...
  return <form action={formAction} className="quick-form"><input name="record_type" type="hidden" value="contact" /><ContactFields />
    ...
    <button className="primary-button quick-submit" disabled={pending}>{pending ? "Saving…" : state.status === "warning" ? "Create separate contact" : "Save contact"}</button><Feedback state={state} />
  </form>;
}
...
function LeadForm({ action, contacts }: { action: Action; contacts: Row[] }) {
  ...
  return <form action={formAction} className="quick-form"><input name="record_type" type="hidden" value="lead" /><input name="contact_mode" type="hidden" value={mode} />
    ...
    <button className="primary-button quick-submit" disabled={pending}>{pending ? "Saving…" : state.status === "warning" ? "Create separate lead" : "Save lead"}</button><Feedback state={state} />
  </form>;
}
...
function EventForm({ action, contacts, services }: { action: Action; contacts: Row[]; services: Row[] }) {
  ...
  return <form action={formAction} className="quick-form"><input name="record_type" type="hidden" value="event" />
